...
func (db *DB) CreateBangumi(bangumi *model.Bangumi) error {
	return db.Create(bangumi).Error
}
...
// ListIncompleteBangumi 查询未完成的番剧
// func (db *DB) ListIncompleteBangumi() ([]*model.Bangumi, error) {
// 	var bangumis []*model.Bangumi
// 	err := db.Where("eps_collect = ? AND deleted = ?", false, false).
// 		Find(&bangumis).Error
// 	return bangumis, err
// }

// // DeleteAllBangumi 删除所有番剧
// func (db *DB) DeleteAllBangumi() error {
// 	return db.Where("1 = 1").Delete(&model.Bangumi{}).Error
// }
