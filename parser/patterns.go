...
var (
	// ChinesePattern 中文字符匹配
	ChinesePattern = regexp2.MustCompile(`[\u4e00-\u9fff]`, regexp2.None)
	// JapanesePattern 日文字符匹配
	JapanesePattern = regexp2.MustCompile(`[\u3040-\u309f\u30a0-\u30ff]`, regexp2.None)
	// MixedPattern 中日文混合字符匹配
	MixedPattern = regexp2.MustCompile(`[\u4e00-\u9fff\u3040-\u309f\u30a0-\u30ff]+`, regexp2.None)
)
